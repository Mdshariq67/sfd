...
class Course_video2 extends StatefulWidget {
  const Course_video2({Key? key}) : super(key: key);

  @override
  State<Course_video2> createState() => _Course_video2State();
}

class _Course_video2State extends State<Course_video2> {
